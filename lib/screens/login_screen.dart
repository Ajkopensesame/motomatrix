...
class LoginScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: CustomBackground(  // <-- Use the CustomBackground here
        child: Padding(
          ...
          child: Form(
            child: Column(
              ...
              children: [
                CustomTextField(  // <-- Use the CustomTextField here
                ...
                SizedBox(height: 32),
                CustomElevatedButton(  // <-- Use the CustomElevatedButton here
                  label: 'Login',
                  onPressed: () async {
                    try {
                ...
                CustomTextButton(  // <-- Use the CustomTextButton here
